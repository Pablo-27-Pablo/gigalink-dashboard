...
const sessionsData = [
  {
    ...
    code: "****21BZ",
    plan: "Premium 5GB",
    accessed: " 10:30:12 AM; 2023-12-10",
    remaining: 2.5,
    status: "Online",
  },
  {
  ...
  },
  {
    ...
    code: "****21MP",
    plan: "Standard 2GB",
    accessed: " 9:45:30 AM; 2023-12-01",
    remaining: 2,
    status: "Online",
  },
  {
    ...
    code: "****12RW",
    plan: "Giga 10GB",
    accessed: " 4:20:10 PM; 2023-11-28",
    remaining: 4.5,
    status: "Online",
  },
  {
    ...
    code: "****22TJ",
    plan: "Premium 5GB",
    accessed: " 11:00:00 AM; 2023-12-15",
    remaining: 4,
    status: "Online",
  },
];
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
                {filteredSessions.map((session) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-slate-600 dark:text-slate-300">
                      {session.remaining === 999
                        ? "∞"
                        : `${session.remaining} GB`}
                    </td>
