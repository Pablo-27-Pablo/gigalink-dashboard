...
export default function Services() {
  const [selectedPlan, setSelectedPlan] = useState<(typeof services)[0] | null>(
    null,
  );
    ...
    <div className="space-y-8 p-6">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <p className="text-slate-500 dark:text-slate-400">
          Choose the best data plan that suits your needs. Click to generate QR
          Code.
        </p>
      </div>
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div
                    className={cn(
                      ...
                      selectedPlan.quota <= 50
                        ? "bg-red-50 dark:bg-red-900/10 border-red-200 dark:border-red-800"
                        : selectedPlan.quota <= 150
                  ...
                  >
                    ...
                    <div className="w-full h-2 rounded-full bg-slate-200 dark:bg-slate-600 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(selectedPlan.quota / 250) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
                ...
                <div className="flex gap-3">
                  <button
                    onClick={() => setShowConfirmation(false)}
                    className="flex-1 py-3 px-4 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-900 dark:text-white rounded-xl font-medium transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    onClick={handleGenerateVouchers}
                    className="flex-1 py-3 px-4 bg-teal-500 hover:bg-teal-600 text-white rounded-xl font-semibold transition-colors shadow-md shadow-teal-500/30"
                  >
                    Generate
                  </button>
                </div>
              ...
              <div className="flex justify-between items-center mb-6">
                <div>
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
                    {generatedVouchers.length} voucher
                    {generatedVouchers.length > 1 ? "s" : ""} created
                    successfully
                  </p>
                </div>
