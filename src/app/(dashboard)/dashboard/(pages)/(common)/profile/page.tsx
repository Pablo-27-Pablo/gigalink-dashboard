...
export default function Profile() {
  return (
    <div className={cn("min-h-screen bg-[#f8fafc] transition-colors", "dark:bg-slate-950")}>
      <main className="max-w-4xl mx-auto pt-12 pb-20 px-4">
        {/* Page Header */}
        <div className="text-center mb-10">
          <h1 className={cn("text-3xl font-bold text-[#0f172a]", "dark:text-white")}>
            Profile Settings
          </h1>
        ...
        >
          ...
          <div className="pt-20 pb-12 px-10">
            <h2 className={cn("text-2xl font-bold text-[#0f172a] text-center mb-12", "dark:text-white")}>
              BARMM DISTRIBUTOR
            </h2>

            <div className="max-w-xl mx-auto space-y-8">
              {/* Email Row */}
              <div className={cn("flex items-center gap-5 pb-6 border-b border-slate-100", "dark:border-slate-800")}>
                <div className={cn("p-3 bg-[#f8fafc] rounded-xl text-slate-500 border border-slate-100", "dark:bg-slate-800/50 dark:border-slate-700")}>
                  <Mail size={22} />
                </div>
                <div className="flex-1">
                  ...
                  <p className={cn("text-slate-700 text-sm md:text-base", "dark:text-slate-200")}>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-1">
                    {[...Array(12)].map((_, i) => (
                      <div
                        key={i}
                        className={cn("w-1.5 h-1.5 bg-slate-800 rounded-full", "dark:bg-slate-400")}
                      />
                    ))}
                  </div>
                </div>
