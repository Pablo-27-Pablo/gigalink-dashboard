        ...
        {portals.map((portal, index) => (
          ...
          >
            ...
            <div className="p-8 flex flex-col items-center text-center gap-5">
              <div
                className={`w-16 h-16 rounded-2xl ${portal.bg} flex items-center justify-center`}
              >
              ...
              <button
                className={`w-full py-3 px-4 ${portal.button} text-white rounded-xl font-semibold text-sm flex items-center justify-center gap-2 shadow-md transition-colors group`}
              >
                Enter Portal
                <ArrowRight
                  size={16}
